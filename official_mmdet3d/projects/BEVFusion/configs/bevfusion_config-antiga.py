...
# ===== Modelo completo (com code_size=8 e sem 'vel') =====
model = dict(
    type='BEVFusion',
    use_camera=True,
...
# ===== Desativar validação =====
# Removemos val_dataloader, val_cfg e val_evaluator
# e definimos val_interval=0 no train_cfg
...
train_cfg = dict(
    by_epoch=True,
    max_epochs=6,
    val_interval=0   # desativa validação
)

test_cfg = dict()

# ===== Work directory =====
work_dir = './work_dirs/bevfusion_plastipak'
#===============================================================================================
# BEVFusion - Configuração para treinamento e avaliação do modelo BEVFusion no dataset Plastipak
#===============================================================================================
...
metainfo = dict(classes=METAINFO["classes"], palette=METAINFO["palette"])
...
if ann_file_train is None:
    raise ValueError(
        "O arquivo de anotação de treinamento não foi especificado. Por favor, defina 'ann_file' corretamente."
    )
...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_heatmap=dict(
            type="mmdet.GaussianFocalLoss", loss_weight=1.0, reduction="mean"
        ),
        loss_cls=dict(
        ...
        train_cfg=dict(
            ...
            assigner=dict(
                ...
                cls_cost=dict(
                    type="mmdet.FocalLossCost", alpha=0.25, gamma=2.0, weight=0.15
                ),
